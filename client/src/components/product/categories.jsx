        ...
        <div className="section">
            <div className="container">
                <div className="row">
                    ...
                    <span className="bodySmall mb-5 text-center">Explore a World of Choices Across Our Most Popular 
                        <br/> Shopping Categories
                    </span>
                    {
                            ...
                            <div key={index} className="col-6 col-lg-8r text-center col-md-8r p-2">
                                <Link to={`/by-category/${item['_id']}`} className="card h-100 rounded-3 bg-light">
                                    <div className="card-body">
                                        <img alt="" className="w-75" src="https://shorturl.at/IPai7" />
