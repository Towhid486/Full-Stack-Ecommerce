...
const InvoiceDetails = () => {
    ...
    if(InvoiceDetails==null){
        ...
        return  <EmptyCartList text={"No data found for this invoice"}/>
    }
    else {
        return (
                                    ...
                                    InvoiceDetails.map((item,i)=>{
                                        return(
                                            <li key={i} className="list-group-item d-flex justify-content-between align-items-start">
                                                <img className="rounded-1" alt="" width="90" height="auto" src={'https://www.apple.com/newsroom/images/product/mac/standard/Apple_16-inch-MacBook-Pro_111319_big.jpg.large.jpg'}/>
