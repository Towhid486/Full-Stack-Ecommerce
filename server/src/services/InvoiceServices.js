...
// =============Step 01: Calculate Total Payable & Vat=====================================================================================
    ...
    let CartProducts = await CartModel.aggregate([matchStage,JoinStageProduct,unwindProduct])
...
// =============Step 02: Prepare  Customer Details & Shipping Details=====================================================================================
    ...
    let cus_details = `Name:${Profile[0]['cus_name']}, Email:${cus_email}, Adress:${Profile[0]['cus_add']}, Phone:${Profile[0]['cus_phone']}`
...
// =============Step 04: Create Invoice=====================================================================================
    ...
    let  createInvoice = await InvoiceModel.create({
        ...
        delivery_status:delevery_status,
        total:totalAmount,
        vat:vat
    })
...
exports.InvoiceProductListService = async(req)=>{
    try{
        ...
        let invoice_products = await InvoiceProductModel.aggregate([
            matchStage,JoinStageProduct,unwindProduct
        ])
        return {status:"success", data:invoice_products}
    }
    catch (e) {
        return {status:"fail", message:"Something Went Wrong"}
    }
